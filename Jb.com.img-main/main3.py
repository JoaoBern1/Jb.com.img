...
# Variáveis para controle de rendimensionamento
...
while running: 
        ...
        # Verificar se o tamanho da janela foi alterado
        current_width, current_height = screen.get_size()

        # Se a fanela foi rendimensionada, centralizada a imagem
        if current_width != last_width or curret_height !=last_height:
